...
foreach ($worksites as $worksite) {
  ...
  echo '<div class="col-lg-4 col-md-6 worksite-item isotope-item filter-' . strtolower($worksite_description->categorie) . '">
        ...
        <div class="worksite-info">
          ...
          <a class="details-link" href="views/chantiers-details.php?description=' . $worksite_subfolder[0] . '&images=' . $worksite_subfolder[1] . '" data-toggle="modal" data-target="#worksiteDetailModal" title="Plus de détails"><i class="fa-solid fa-plus"></i></a>
        </div>
      </div>';
}
